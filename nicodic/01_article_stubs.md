[英語プロンプト実験 »](./02_article_stubs_en.md)
...
- 以下は「{tag}」というタグがついた動画のタイトルと概要欄です。このタグについて、一番重要な情報だけを一文にまとめてください。{video_info}
- {返事}
...
- **正解**: スーパーロボット大戦の外伝に登場する操縦者
- **記事**: yes （操縦するロボットに転送される）
- **top N**: 8
- **AI が既に知っている**: no

**結果**

> 「マサキ・アンドー」というタグはありません。
>
> 1. 「マサキ・アンドー」とは誰か、何をしていた人物なのか。
> 2. 「マサキ・アンドー」というタグが付けられた動画の傾向や特徴。
> 3. 「マサキ・アンドー」というタグを使う視聴者や投稿者の属性や嗜好。
> 4. タグの起源や普及の背景など、タグがニコニコ動画のコミュニティーにおいてどのような役割を果たしているか。
